...
var Swipeable = function (_React$Component) {
  ...
  Swipeable.prototype.render = function render() {
    ...
    var nativeTouchMoveListener = newProps.preventDefaultTouchmoveEvent && DetectPassiveEvents.hasSupport;
    if (!disabled) {
    ...
    newProps.ref = function (element) {
      if (!element && nativeTouchMoveListener) {
        _this2.element.removeEventListener('touchmove', _this2.eventMove, { passive: false });
      }

      _this2.element = element;

      if (element && nativeTouchMoveListener) {
        _this2.element.addEventListener('touchmove', _this2.eventMove, { passive: false });
      }
